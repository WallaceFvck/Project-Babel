 ...
 */
@Mod.EventBusSubscriber(modid = ProjectBabelMod.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public class KeyBindings {
    ...
    public static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        ...
        ProjectBabelMod.LOGGER.info("[projectbabel] Keybind registrado: H → Abrir Menu.");
    }
}
