...
public class GoogleTranslateEngine {
    ...
    public CompletableFuture<String> translate(String text, String src, String tgt) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                ProjectBabelMod.LOGGER.debug("[projectbabel] Google direto: {}", e.getMessage());
            }
            ...
            try {
                ...
                ProjectBabelMod.LOGGER.debug("[projectbabel] Google DoH: {}", e.getMessage());
            }
            ...
            try {
                ...
                ProjectBabelMod.LOGGER.debug("[projectbabel] Google proxy: {}", e.getMessage());
            }

            int f = consecutiveFails.incrementAndGet();
            if (f >= AutoTranslateConfig.getFailureThreshold()) {
    ...
    private String translateViaDoH(String text, String src, String tgt) throws Exception {
        ...
        try {
            ...
            if (statusCode == 200) {
                ...
                ProjectBabelMod.LOGGER.debug("[projectbabel] Google DoH OK via {}", ip);
                return result;
            }
    ...
    private String parseResponse(String json) {
        try {
            ...
            ProjectBabelMod.LOGGER.debug("[projectbabel] Google parse: {}", e.getMessage());
            return null;
        }
    }
