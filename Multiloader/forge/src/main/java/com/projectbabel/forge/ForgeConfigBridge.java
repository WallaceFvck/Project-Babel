...
import com.projectbabel.forge.config.AutoTranslateConfig;
import com.projectbabel.platform.BabelConfigView;
import net.minecraftforge.common.ForgeConfigSpec;

/** Forge-backed mutable config view exposed to common code. */
public final class ForgeConfigBridge implements BabelConfigView {
    public static ForgeConfigSpec spec() { return AutoTranslateConfig.SPEC; }
