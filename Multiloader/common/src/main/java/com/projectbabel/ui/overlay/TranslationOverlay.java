package com.projectbabel.ui.overlay;
...
public class TranslationOverlay {
    ...
    public static void render(GuiGraphics graphics) {
        ...
        boolean enabled = ProjectBabelCommon.config().isEnabled();
    ...
    private static void renderInternal(GuiGraphics graphics, Minecraft mc, boolean enabled) {
        ...
        String firstLine = state + "  " + engine + (ProjectBabelCommon.config().isTurboMode() ? "  TURBO" : "");
