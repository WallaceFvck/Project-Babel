...
public final class ComponentTemplateTranslator {
    ...
    private static Component translate(Component component, boolean cacheOnly) {
        ...
        String translated = cacheOnly
            ? TranslationPipeline.translateString(template.text(), TranslationContext.book(false).asCacheOnly())
            : TranslationPipeline.translateString(template.text(), TranslationContext.book(true));
    ...
    private static Component rebuild(
        ...
        for (Anchor anchor : template.anchors()) {
            ...
            Component anchorComponent = cacheOnly
                ? TranslationPipeline.translateComponent(anchor.component(), TranslationContext.book(false).asCacheOnly())
                : TranslationPipeline.translateComponent(anchor.component(), TranslationContext.book(false));
