...
public class LanguageDetector {
    ...
    public static String getTargetLanguageForApi() {
        if (ProjectBabelCommon.config().isFollowClientLanguage()) {
            return normalizeLanguage(getClientLanguageCode());
        }
        return normalizeLanguage(ProjectBabelCommon.config().getTargetLang());
    }
    ...
    public static String getClientLanguageCode() {
        ...
        return ProjectBabelCommon.config().getTargetLang().toLowerCase(Locale.ROOT).replace('-', '_');
    }
    ...
    public static void prepopulateFromGameLanguages() {
        try {
            ...
            ProjectBabelCommon.LOGGER.debug("[projectbabel] prepopulateFromGameLanguages: {}", e.getMessage());
        }
    }
}
