...
public abstract class FTBLibraryThemeMixin {
    ...
    @ModifyVariable(
        method = {
            "drawString(Lnet/minecraft/client/gui/GuiGraphics;Ljava/lang/Object;IILdev/ftb/mods/ftblibrary/icon/Color4I;I)I",
            "drawString(Lnet/minecraft/class_332;Ljava/lang/Object;IILdev/ftb/mods/ftblibrary/icon/Color4I;I)I"
        },
        at = @At("HEAD"),
        argsOnly = true,
        index = 2,
    ...
    @ModifyVariable(
        method = {
            "drawString(Lnet/minecraft/client/gui/GuiGraphics;Ljava/lang/Object;III)I",
            "drawString(Lnet/minecraft/class_332;Ljava/lang/Object;III)I"
        },
        at = @At("HEAD"),
        argsOnly = true,
        index = 2,
    ...
    @ModifyVariable(
        method = {
            ...
            "drawString(Lnet/minecraft/class_332;Ljava/lang/Object;II)I"
        },
        at = @At("HEAD"),
        argsOnly = true,
        index = 2,
    ...
    private Object translateObject(Object text) {
        if (text == null || LayoutSensitiveScreenGuard.shouldSkipLateRenderTranslation()) return text;

        try {
            if (text instanceof Component component) {
                return RenderFallbackTranslator.translateComponent(component);
            }

            if (text instanceof String string) {
                return RenderFallbackTranslator.translateString(string);
            }
